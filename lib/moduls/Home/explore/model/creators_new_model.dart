...
///
class CreatorsNewModelDataUsersLinks {
/*
{
  "url": null,
...
*/
  ...
  CreatorsNewModelDataUsersLinks({
    this.url,
    this.label,
    this.active,
  });
  CreatorsNewModelDataUsersLinks.fromJson(Map<String, dynamic> json) {
...
class CreatorsNewModelDataUsersData {
/*
{
  "id": 42,
  "name": "Deo Deo",
  ...
  "avatar": "u42-4216607996595su5jmyyoi.jpg",
  ...
  "twitch": "",
  "discord": "",
  "api_token": "CTm21eqq2mnBQ3FnlG0wHabHGcKvt3S7visFZ8GmKX4kTXeVf70TykCyITy8",
  "mobile": null,
  "cover_url": "https://fans2.s3.eu-west-1.wasabisys.com/uploads/cover/u42-421660806755oeskrc4spx.jpg",
  "avatar_url": "https://fans2.s3.eu-west-1.wasabisys.com/uploads/avatar/u42-4216607996595su5jmyyoi.jpg"
}
*/
  ...
  CreatorsNewModelDataUsersData.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toInt();
...
class CreatorsNewModelDataUsers {
/*
{
  "current_page": 1,
  "data": [
  ...
  "first_page_url": "https://alpha.fans2.co.tz/api/creators/new?page=1",
  "from": 1,
  "last_page": 1,
  "last_page_url": "https://alpha.fans2.co.tz/api/creators/new?page=1",
  "links": [
    {
      "url": null,
      "label": "pagination.previous",
  ...
  "next_page_url": null,
  "path": "https://alpha.fans2.co.tz/api/creators/new",
  "per_page": 12,
  "prev_page_url": null,
  "to": 4,
  "total": 4
...
*/
  ...
  int? currentPage;
  List<CreatorsNewModelDataUsersData?>? data;
  String? firstPageUrl;
  int? from;
  int? lastPage;
  String? lastPageUrl;
  List<CreatorsNewModelDataUsersLinks?>? links;
  String? nextPageUrl;
  String? path;
  int? perPage;
  String? prevPageUrl;
  ...
  CreatorsNewModelDataUsers.fromJson(Map<String, dynamic> json) {
    currentPage = json['current_page']?.toInt();
    if (json['data'] != null) {
      final v = json['data'];
      final arr0 = <CreatorsNewModelDataUsersData>[];
      v.forEach((v) {
        arr0.add(CreatorsNewModelDataUsersData.fromJson(v));
      });
      this.data = arr0;
    }
    ...
    if (json['links'] != null) {
      final v = json['links'];
      final arr0 = <CreatorsNewModelDataUsersLinks>[];
      v.forEach((v) {
        arr0.add(CreatorsNewModelDataUsersLinks.fromJson(v));
      });
      links = arr0;
    }
...
/*
{
  ...
  "title": "general.new_creators"
}
*/

  CreatorsNewModelDataUsers? users;
  String? title;

  CreatorsNewModelData({
    this.users,
    this.title,
  });
  CreatorsNewModelData.fromJson(Map<String, dynamic> json) {
    users = (json['users'] != null) ? CreatorsNewModelDataUsers.fromJson(json['users']) : null;
...
*/
  ...
  CreatorsNewModel.fromJson(Map<String, dynamic> json) {
    data = (json['data'] != null) ? CreatorsNewModelData.fromJson(json['data']) : null;
