  ...
  return Column(
    children: [
      Row(
        ...
        children: [
          SizedBox(
              width: 100, child: commonText(text: title, style: titleTextStyle ?? FontStyleUtility.blackInter14W500)),
          suffix,
        ],
      ),
      Padding(
...
Future<void> showAlertDialog(
  ...
  return showDialog<void>(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        titlePadding: title == null ? EdgeInsets.zero : const EdgeInsets.all(10),
              ...
              msg != null
                  ? Text(msg,
                      style: blackInter16W500.copyWith(
                          height: 1.5,
                          color: isDarkOn.value == true ? colorWhite.withOpacity(0.8) : colorBlack.withOpacity(0.8)),
        ...
        actions: actions ??
            <Widget>[
              showNegativeButton ?? true
                  ? TextButton(
                      child: Text(negativeTitle ?? 'No', style: blackInter16W600),
                      onPressed: () {
                        Get.back();
                      },
                    )
